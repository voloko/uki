    ...
    rightChildViews: { view: 'SplitPane', id: 'splitRight', rect: '795 950', anchors: 'left top right bottom', handleWidth: 15, handlePosition: 300, leftMin: 300, rightMin: 300,
        ...
        rightChildViews: panel('Simplicity is the key', { rect: '470 930', background: 'theme(panel-blue)', childViews: [
            { view: 'Box', rect: '0 23 470 56', background: 'theme(box-lblue)', anchors: 'left top right', childViews: [
                { view: 'Image', rect: '7 7 40 40', anchors: 'left top', src: '/app/functional/wave/voloko.jpg', background: 'theme(thumb)' },
...
uki('#contactsList').data(contacts).dirtyParent().layout();
uki('#waveList').data(waves).dirtyParent().layout();
