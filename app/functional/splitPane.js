uki(
    { view: 'SplitPane', rect: '1000 600', anchors: 'left top right bottom', handlePosition: 200, rightMin: 500, handleWidth: 1, id: 'top',
        ...
        rightChildViews: { view: 'SplitPane', rect: '799 600', anchors: 'left top right bottom', id: 'second',
            ...
            leftPane: {  background: '#D0D7E2', childViews: [
                    { view: 'Button', rect: '10 566 280 24', anchors: 'bottom left right', text: 'left pane', focusable: false }
                ]},
            rightChildViews: [
                { view: 'VerticalSplitPane', rect: '498 600', anchors: 'left top right bottom',
                    topChildViews: [
                    ...
                    bottomPane: { background: '#FFF', childViews: [
                        ...
                        { view: 'Label', rect: '10 80 479 300', anchors: 'top left right bottom', multiline: true, html: 'Text ', id: 'workpane' }
                    ]}
                }
            ]
        }
