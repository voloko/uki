function elements() {
    return [    
        ...
        { view: 'Radio',    rect: '720px 10px 24px 24px',  anchors: 'left top', name: 'probe', group: 'radio_1' },
        { view: 'Label',    rect: '745px 10px 100px 24px', anchors: 'left top', html: 'Radio 1', selectable: false },
        { view: 'Radio',    rect: '720px 35px 24px 24px',  anchors: 'left top', checked: true, group: 'radio_1' },
        { view: 'Label',    rect: '745px 35px 100px 24px', anchors: 'left top', text: 'Radio 2', selectable: false },
...
uki(
    { view: 'Box', rect: '0 0 1000px 300px', minSize: '980 0', anchors: 'top left right width', childViews: [
