function elements() {
    return [    
        ...
        { view: 'Input',    rect: '720 10 100 34',         anchors: 'right top', value: "Big input" },
        { view: 'Slider',   rect: '400 45 310px 24px',     anchors: 'right top', autosize: 'width' }
    ];
}

uki(
    { view: 'Base', rect: '0 0 1000px 300px', anchors: 'top left right', autosize: 'width', childViews: [
