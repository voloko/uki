...
Just rendering the table made any IE busy for half a minute. TODO: Uki uses progressive rendering and can do it mostly instantly.
...
== Specific
Uki doesn't want to be a Jack-of-all-trades. It only does layout but it does it well. You won't find any Model layer code here. 
